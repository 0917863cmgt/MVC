@props(['comment', 'selected', 'hasCommentLike', 'commentLike'])
                ...
                <span class="jdtwu">
                    <div class="_2ic5v">
                        @if($hasCommentLike == true)
                            <form class="like-highlight-form" method="POST" action="/highlights/s/{{$selected->slug}}/destroy-comment-like/{{$commentLike->id}}">
                                @csrf
                                ...
                                <button class="highlight-svg-button" type="submit">
                                    ...
                                    <div class="QBdPU rrUvL">
                                        <span class="">
                                            <svg aria-label="Like" class="like-highlight-svg" color="#ed4956" fill="#ed4956" height="12" role="img" viewBox="0 0 48 48" width="12">
                        ...
                        @else
                            <form class="like-highlight-form" method="POST" action="/highlights/s/{{$selected->slug}}/store-comment-like">
                            @csrf
                            <input type="hidden" name="highlight_id" id="highlight_id" value="{{$selected->id}}">
                            <input type="hidden" name="comment_id" id="comment_id" value="{{$comment->id}}">
                            <input type="hidden" name="user_id" id="user_id" value="{{auth()->user()->id}}">
