                        ...
                        <div class="row comment-form-row">
                            <div class="col comment-form-column">
                                <form class="comment-form" method="POST">
                                    ...
                                    <textarea aria-label="Add a comment…" placeholder="Add a comment…" class="comment-inputfield" autocomplete="off" autocorrect="off"></textarea>
                                    <button class="comment-post-button" disabled="" type="submit">Post</button>
                                </form>
                            </div>
                        </div>
                    </div>
